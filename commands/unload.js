...
module.exports = {
    ...
    options: [
      {
        name: 'nactag',
        description: 'Does your carrier have the N.A.C. tag?',
        required: true,
        default: false,
      ...
      {
        name: 'commodity',
        description: "The commodity your carrier is unloading. Agronomic Treatment may be typed as agro or Agro.",
        required: true,
        type: DiscordJS.Constants.ApplicationCommandOptionTypes.STRING,
      },
      {
        name: 'station',
        description: "The station your carrier is unloading to.",
        required: true,
        type: DiscordJS.Constants.ApplicationCommandOptionTypes.STRING,
      },
      {
        name: 'system',
        description: "The system you are unloading in.",
        required: true,
        type: DiscordJS.Constants.ApplicationCommandOptionTypes.STRING,
      },
      {
      ...
      {
        name: 'units',
        description: "How many units your carrier is unloading.",
        required: true,
        type: DiscordJS.Constants.ApplicationCommandOptionTypes.STRING,
      },
      {
